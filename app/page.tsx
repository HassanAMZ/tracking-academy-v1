 ...
 return (
  <main className=''>
   ...
   <TestimonialCard
    ...
    person={{
     testimonial:
      "Very thorough and professional. Identified a problem and implemented a complete overhaul that has resolved the issues.",
     position: "Head of Growth | Tonic Health",
     name: "Jamie Norsa",
     image: {
